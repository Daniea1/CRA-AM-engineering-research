...
\title{Security of Additive Manufacturing Systems: Merged Threat Taxonomy}
\author{%
Sami Gawad\\
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Additive Manufacturing Merged Threat Taxonomy}
...
\vspace*{1.5cm}
\vspace{1.2cm}
{\Huge\bfseries\color{ReportBlue} Security of Additive\\[0.25em]Manufacturing Systems\par}
\vspace{0.5cm}
{\Large Merged threat taxonomy, mitigation mapping, and CRA crosswalk\par}
\vspace{1.2cm}
\vfill
...
The short version is: \textbf{goals explain why, targets explain where, methods explain how, and the MITRE mapping explains what defensive control families are relevant.}
